#!/usr/bin/env python3
"""Render an assembled foxio-portfolio HTML deck to an A4 PDF via headless Chromium.
...
def main():
    ...
    with sync_playwright() as p:
        ...
        # The deck's own @page{size:A4;margin:0} rule drives the page box —
        # prefer_css_page_size lets it win over Playwright's default Letter size.
